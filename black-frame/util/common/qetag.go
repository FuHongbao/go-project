...
func GetResourceQeTag(ctx context.Context, filename string) (etag string, err error) {
...
func GetSrcPath(key string) string {
	return "./src_video/" + key + ".mp4"
}
func GetDestPath(key string) string {
	return "./dest_video/" + key
}
